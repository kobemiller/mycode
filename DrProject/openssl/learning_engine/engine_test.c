// =====================================================================================
//
//       Filename:  engine_test.c
//
//    Description:  
//
//        Version:  1.0
//        Created:  06/16/2015 09:13:42 PM
//       Revision:  none
//       Compiler:  g++
//
//         Author:   (), 
...
const EVP_CIPHER *EVP_hw_cipher()
{
    return &EVP_hw_c;
}
...
int main()
{
    ...
    strcpy((char *)in, "abcccccccccccccccccccc");
